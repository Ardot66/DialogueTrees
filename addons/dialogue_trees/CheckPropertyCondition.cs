...
[Tool]
[GlobalClass]
public partial class CheckPropertyCondition : DialogueCondition
{
	...
	public override bool Invoke(params Variant[] parameters)
	{
		...
		return targetedNode.Get(_property).Obj.Equals(_value.Obj);
	}
